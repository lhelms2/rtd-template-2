$( document ).ready(function() {
  ...
  wysidenavsearch = document.querySelector("body > div > nav > div > div.wy-side-nav-search > a > img");
  wysidenavsearch.insertBefore(project_name_link, wysidenavsearch.img);
